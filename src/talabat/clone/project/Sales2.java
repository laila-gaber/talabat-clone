    ...
    for( int i =1 ; i<getOrder.numberOfOrder ; i++)
         {
            ...
            name[i] = new JLabel(getOrder.name_food[i]);
            price[i] = new JLabel(String.valueOf(getOrder.price_food[i]));  
            type[i]= new JLabel(getOrder.type_food[i]);
            quant[i]= new JLabel(String.valueOf(getOrder.number_food[i]));

            //To set the font prorties 
            name[i].setFont(new Font("tahoma" , Font.BOLD ,12));
            price[i].setFont(new Font("tahoma" , Font.BOLD ,12));
            type[i].setFont(new Font("tahoma" , Font.BOLD ,12));
