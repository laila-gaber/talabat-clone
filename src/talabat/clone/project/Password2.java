...
public Password2()
{
        ...
        Confirm.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 153, 0), 1, true));
        ...
        Cancel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 153, 0), 1, true));
        ...
        ConfirmPassword.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 153, 0), 1, true));
     ...
     public class ConfirmMouseLesiner implements MouseListener 
      {
        ...
        }else if ((pass<6)) 
        {
            ...
            dispose();
                ...
                Confirm.setBorder(new LineBorder(new Color(255,153,0),1,true));
            }
        ...
        public void mouseExited(MouseEvent e) {
            if(e.getSource()==Confirm)
            {
            Confirm.setBackground(new Color(255,153,0));
            Confirm.setForeground(Color.white);
            Confirm.setBorder(new LineBorder(new Color(255,153,0),1,true));
        }
        }
      ...
      public class CancelMouse implements MouseListener 
      {
        ...
        public void mouseClicked(MouseEvent e) {
            if(e.getSource()==Cancel)
            {
                ...
                Cancel.setBorder(new LineBorder(new Color(255,153,0),1,true));
        ...
        public void mouseExited(MouseEvent e) {
            if(e.getSource()==Cancel)
            {
            Cancel.setBackground(new Color(255,153,0));
            Cancel.setForeground(Color.white);
            Cancel.setBorder(new LineBorder(new Color(255,153,0),1,true));
        }
        }
